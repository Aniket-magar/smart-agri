...
<style>
    ...
    <div class="container text-center mt-4">
        <h1 class="text-success">Seasons and Crops</h1>
        <div class="row mt-4">
            <!-- Rabi Season Card -->
            <div class="col-md-6">
                <div class="card season-card" onclick="showCrops('rabi')">
                    <img src="rabi.jpg" class="card-img-top" alt="Rabi Season">
                    <div class="card-body">
                        <h5 class="card-title">Rabi Season</h5>
                        <p class="card-text">Click to see crops grown in the Rabi season.</p>
                    </div>
                </div>
            </div>
            <!-- Kharif Season Card -->
            <div class="col-md-6">
                <div class="card season-card" onclick="showCrops('kharif')">
                    <img src="kharif.jpg" class="card-img-top" alt="Kharif Season">
                    <div class="card-body">
                        <h5 class="card-title">Kharif Season</h5>
                        <p class="card-text">Click to see crops grown in the Kharif season.</p>
                    </div>
                </div>
            </div>
        </div>
...
<h1 class="text-success mt-5">Farming Tools</h1>  <!-- Changed from text-primary to text-success -->
<div class="row mt-4" id="toolsContainer">
    <!-- Tools will load dynamically -->
</div>

    <!-- Modal for Crops and Tools -->
